      ...
      <table>
            ...
            <tr>
            	<td>Mã DM</td><td>
					...
					<option value="1">Khô Gà Lá Chanh</option>
					<option value="2">Khô Bò</option>
					<option value="3">Bánh Gấu</option>
					<option value="4">Trái Cây Sấy</option>
					<option value="5">Bim</option>
					<option value="6">Bắp Cay</option>
					<option value="7">Rong Biển</option>
					<option value="8">Cơm Cháy</option>
