...
if(isset($_GET['timkiem']))
{
  ...
  {
	case "1":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%' and (gia between '38000' and '70000')";	
	break;
	case "2":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%'  and (gia between '700000' and '100000')";	
	break;
	case "3":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%'  and (gia between '100000' and '150000')";	
	break;
	case "4":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%'  and (gia between '150000' and '200000')";	
	break;
	
	case "5":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%'  and (gia >= '200000')";	
	break;
	default:
